...
function analisis_lineal_equivalente(capas::Vector{capa_suelo}, omega::Vector{Float64}, 
    ...
    for iter in 1:max_iter
        ...
        Vs_diat = n_capas >= 1 ? capas_trabajo[1].Vs_actual : 0.0
        Vs_brecha = n_capas > 22 ? capas_trabajo[23].Vs_actual : 850.0
        zeta_diat = n_capas >= 1 ? capas_trabajo[1].ζ_actual : 0.05
        ...
        @printf("|  %3d | %7.2f%% |     %7.2f |     %7.1f |   %7.1f |    %6.3f |      %6.3f |      %6.3f | %6s |\n",
                iter, error_combinado, factor_relajacion, Vs_diat, Vs_brecha, 
                gamma_diat_max, gamma_brecha_max, zeta_diat, estado)
