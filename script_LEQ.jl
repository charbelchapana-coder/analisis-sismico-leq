...
archivo_sismo = "sismo_recortado_ns.txt"         # Archivo con el registro sísmico
...
archivo_salida = "analisis_LEQ_ns.png"           # Archivo de salida para gráficos
archivo_deconvolucion = "deconvolucion_roca_ns.txt"  # Archivo de salida para señal deconvolucionada
                                                  # PERSONALIZABLE: Cambia este nombre según tu proyecto
                                                  # Ejemplos válidos:
                                                  # "deconvolucion_proyecto1.txt"
                                                  # "sismo_roca_ew.txt" 
                                                  # "analisis_sitio_A_componente_NS.txt"
                                                  # "datos/resultados/deconv_roca.txt" (incluye carpetas)
...
capas = [
    ...
    capa_suelo(1400.0, 500.0, 0.05, 320.0, params_diatomaceo, "Suelo diatomáceo"),
    
    # Capa 2: Suelo duro intermedio (comportamiento lineal)
    capa_suelo(2000.0, 850.0, 0.02, 185.0, params_lineal_brecha, "Brecha sedimentaria"),
...
config = Dict(
    ...
    "archivo_deconvolucion" => archivo_deconvolucion
)
...
resultados_movimientos = calcular_movimientos_y_deformaciones(
    capas_finales, subcapas, omega, f_acc_pos, Amp_final, tiempo, dt, max_iter_conv, tolerancia_conv, archivo_deconvolucion
)
